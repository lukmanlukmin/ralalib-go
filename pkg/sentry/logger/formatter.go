...
import (
	...
	"github.com/lukmanlukmin/ralalib-go/pkg/converter"
)
...
func (f *Formatter) getCurrentPosition(entry *logrus.Entry) (string, string, string) {
	...
	return fr.Function, fr.File, converter.ToString(fr.Line)
}
...
func getCaller() *runtime.Frame {
	...
	lpkg := `github.com/ralali/rll-insurance-service/pkg/logger`
